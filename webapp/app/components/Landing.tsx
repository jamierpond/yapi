        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex gap-6 items-center">
            <a
              ...
              className="flex items-center gap-2 text-sm font-medium text-yapi-fg-muted hover:text-yapi-fg transition-colors"
            >
              ...
              {stars !== null && (
                <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-yapi-bg-elevated border border-yapi-border">
