    ...
    <nav className="relative z-50 px-6 py-4 border-b border-yapi-border/30 backdrop-blur-md bg-yapi-bg/50">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2 sm:gap-3 md:gap-4 items-center">
          ...
          {downloads !== null && (
            <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-yapi-fg-muted bg-yapi-bg-elevated/50 border border-yapi-border rounded-lg">
